...
export default function Hero({ onOpenQuote }) {
  ...
  return (
    <section id="home" className="relative pt-44 sm:pt-48 md:pt-52 lg:pt-56 pb-20 md:pb-28 overflow-hidden bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white">
