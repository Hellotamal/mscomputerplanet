...
export default function ServicesSolar({ onOpenQuote }) {
  return (
    <section id="services-solar" className="py-20 bg-white dark:bg-slate-900 relative overflow-hidden transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-300 text-xs font-bold uppercase tracking-wider mb-3">
            <SunMedium className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
          ...
          <p className="text-slate-600 dark:text-slate-300 text-base sm:text-lg leading-relaxed">
            As the official Channel & Solar EPC Consultant Partner of <strong className="text-slate-900 dark:text-white">Omnis Trades</strong>, 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16">
          {SOLAR_SERVICES.map((srv) => {
            ...
            return (
              <div
                key={srv.id}
                className="bg-slate-50/70 hover:bg-white dark:bg-slate-950/70 dark:hover:bg-slate-800/90 rounded-2xl p-6 sm:p-7 border border-slate-200 dark:border-slate-800 shadow-card hover:shadow-xl hover:border-emerald-300 dark:hover:border-emerald-500/50 transition-all duration-300 flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-12 h-12 rounded-xl bg-emerald-100 text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-300 flex items-center justify-center group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                  ...
                  <div className="border-t border-slate-200/80 dark:border-slate-800 pt-4 mb-5">
                ...
                <div className="flex items-center gap-2 pt-2">
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-xs sm:text-sm font-semibold text-emerald-800 dark:text-emerald-300 bg-emerald-100/70 dark:bg-emerald-950/60 hover:bg-emerald-600 hover:text-white dark:hover:bg-emerald-600 dark:hover:text-white border border-transparent dark:border-emerald-800/40 transition-colors"
                  >
